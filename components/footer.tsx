        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <Link
                href="#"
                className="flex h-10 w-10 items-center justify-center border border-border text-muted-foreground transition-colors hover:bg-fuchsia hover:text-fuchsia-foreground hover:border-fuchsia"
              >
              ...
              <Link
                href="#"
                className="flex h-10 w-10 items-center justify-center border border-border text-muted-foreground transition-colors hover:bg-turquoise hover:text-turquoise-foreground hover:border-turquoise"
              >
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-turquoise">Shop</h3>
          ...
          {/* About */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-gold">About</h3>
            <ul className="space-y-3">
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-fuchsia">Join Our Community</h3>
