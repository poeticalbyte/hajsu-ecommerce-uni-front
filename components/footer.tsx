        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-5 lg:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-semibold tracking-wide">Qhawa</span>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-turquoise">Newsletter</h3>
            <p className="text-sm text-muted-foreground">
              Stories from the Andes and exclusive offers.
            </p>
            <div className="flex gap-2">
              <Input
                type="email"
